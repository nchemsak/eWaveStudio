  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      options: {
        ...
        esnext: true,
        globalstrict: true,
        globals: {"MediaRecorder": true, "QwertyHancock": true, "angular": true, "app": true, "WebMidi": true, "module": true, "Tone": true, "require": true, "Global": true}, //put global variables here ex: {"Sandwich": true, "require": true}
        browserify: true
      }
    },
    sass: {
