...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    jshint: {
      ...
      options: {
        predef: ["document", "console", "Module", "$", "AudioContext", "MediaSource", "$scope", "firebase", "$location", "WebMidi", "module", "require", ], //predefined
        esnext: true,
        globalstrict: true,
        globals: {"angular": true, "app": true, "WebMidi": true, "module": true, "require": true, "Global": true, "MediaRecorder": true, "AudioContext": true}, //put global variables here ex: {"Sandwich": true, "require": true}
        browserify: true
      }
    },
    sass: {
